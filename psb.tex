...
\caption{Plot of the number of drugs in an interaction versus the number of unique drug combinations in AEOLUS with at least 10 reports available. The vertical axis is horizontal, demonstrating the approximately exponential increase in models to compute in the number of drugs interacting. Values above each bar indicate the ``efficiency'' of the nSides approach: the percentage of all drug combinations with $\geq$ 10 available reports.}
