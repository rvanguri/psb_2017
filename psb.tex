...
GitHub:
\begin{itemize}
\item Front-end \url{https://github.com/tatonetti-lab/nsides}
\item Middleware \url{https://github.com/tatonetti-lab/nsides/tree/master/job_api}
\item Back-end \url{https://github.com/tatonetti-lab/nsides/tree/master/condor}
\end{itemize}
...
were able to compute adverse reactions for the drug dabigatran using
